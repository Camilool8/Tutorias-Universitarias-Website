  ...
  return (
    <>
      <SEO
        ...
        description="Panel de administración de Tutorías Universitarias"
        canonicalUrl="https://www.tutoriasuniversitarias.com/admin/login"
      >
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
          ...
          <form
            onSubmit={isSetup ? handleSetup : handleSubmit}
            className="space-y-6"
          >
            <div>
              <label
