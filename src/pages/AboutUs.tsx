        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-4xl font-bold mb-4 text-indigo-700">Nuestra Misión</h2>
              <p className="text-xl text-gray-700 leading-relaxed">
                En Tutorias Universitarias, nos dedicamos a proporcionar apoyo académico de alta calidad a estudiantes universitarios. Nuestro objetivo es facilitar el aprendizaje, fomentar el crecimiento académico y ayudar a los estudiantes a alcanzar su máximo potencial.
              </p>
              <div className="flex items-center space-x-4 text-indigo-600">
                <Target size={32} />
                <span className="text-2xl font-semibold">Excelencia Académica</span>
              </div>
            </motion.div>
          </div>
          ...
          >
            <h2 className="text-4xl font-bold mb-10 text-indigo-800 text-center">Nuestros Valores</h2>
          ...
          >
            <h2 className="text-4xl font-bold mb-6 text-indigo-700">Nuestro Compromiso</h2>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        <ChevronDown 
          className={`text-indigo-500 transition-transform duration-300 ${isExpanded ? 'transform rotate-180' : ''}`} 
        />
      </div>
      <motion.p 
