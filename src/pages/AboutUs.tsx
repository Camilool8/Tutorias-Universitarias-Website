        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                ...
                académico de alta calidad a estudiantes universitarios. Nuestro
                objetivo es facilitar el aprendizaje, fomentar el crecimiento
                académico y ayudar a los estudiantes a alcanzar su máximo
                potencial.
              </p>
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Nos comprometemos a proporcionar un servicio ético, confidencial y
              personalizado que se adapte a las necesidades únicas de cada
              estudiante. Nuestro objetivo es no solo ayudar con tareas
              específicas, sino también fomentar el aprendizaje y el crecimiento
